import api, { getClasses, getClassSubjects, getSubjects, addSubject, deleteSubject, linkClassSubject, getExams, addExam, getAllChapters, addClass, deleteClass as deleteClassAPI, getChaptersByClassAndSubject, updateSubject } from '../../API';
...
export default function Classes() {
    ...
    const fetchChapters = async () => {
        try {
            const res = await getChaptersByClassAndSubject(selectedClass, selectedChapterSubject._id);
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={async () => {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        await api.put(
                                                                            `/chapters/${selectedClass?._id || selectedClass}/${selectedChapterSubject._id}/${ch._id}`,
                                                        ...
                                                        <>
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={async () => {
                                                                    ...
                                                                    try {
                                                                        await api.delete(
                                                                            `/chapters/${selectedClass}/${selectedChapterSubject._id}/${ch._id}`
                                                                        );
