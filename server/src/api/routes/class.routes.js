...
const classController = require('../../application/controllers/class.controller');
const examController = require('../../application/controllers/exam.controller');
...
router.get('/classsubjectlinks', classController.getClassSubjects);
